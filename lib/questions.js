...
export function buildQuestions() {
  return {
    ...
    verifiable_story: {
      type: 'noul',
      instructions:
        'Does `post_text` describe a specific event with details that could in principle be checked — a date, place, name, company, artifact, or outcome someone else could confirm — rather than an unfalsifiable parable (vivid details, no anchors, no one and nothing to check)?',
    },
