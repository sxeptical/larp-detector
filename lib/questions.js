...
export const LARP_ROLES = {
  real_person: { emoji: '✅', label: 'REAL ONE', color: 'green' },
  philosopher: { emoji: '☕', label: 'PHILOSOPHER', color: 'amber' },
  tech_visionary: { emoji: '🧙', label: '10X ENGINEER', color: 'purple' },
  influencer: { emoji: '📊', label: 'INFLUENCER', color: 'pink' },
  martyr: { emoji: '🥀', label: 'MARTYR', color: 'rose' },
  bait: { emoji: '🎣', label: 'BAIT', color: 'orange' },
  other: { emoji: '🎭', label: 'LARP', color: 'gray' },
  // Overrides / special cases
  ai_slop: { emoji: '🤖', label: 'AI SLOP', color: 'blue' },
  sponsored: { emoji: '💰', label: 'SPONSORED', color: 'gold' },
};
